...
const AdminDashboard = () => {
  ...
  const actions = [
    {
      to: "/admin/complaints", label: "Review Active Complaints", sub: "Manage and assign all incoming missing person reports", badge: `${activeCount} Active`,
    ...
    {
      to: "/admin/completed", label: "Completed Cases Archive", sub: "Browse and export all closed and resolved incidents", badge: `${resolvedCount} Total`,
    ...
    {
      to: "/admin/verify", label: "Verify Unknown Person", sub: "Run AI facial recognition checks on reported individuals", badge: `${pendingCount} Pending`,
...
/* ════════════════════════════════════════════
   ...
   All styles are plain CSS, easy to modify.
════════════════════════════════════════════ */
...
/* Main heading with typewriter feel */
.ad-hero-title {
...
@keyframes ad-fade-down {
  from { opacity: 0; transform: translateY(-10px); }
  to   { opacity: 1; transform: translateY(0); }
}

@keyframes ad-fade-left {
...
.ad-zone-card:nth-child(2) { animation-delay: 0.5s; }
.ad-zone-card:nth-child(3) { animation-delay: 0.55s; }
.ad-zone-card:nth-child(4) { animation-delay: 0.6s; }
...
/* Alert zone gets a subtle red-tinted left bar */
.ad-zone-card.alert {
...
@keyframes ad-alert-blink {
  0%, 100% { opacity: 1; }
  50%       { opacity: 0.5; }
}

/* ════════════════════════════════════════════
   RECENT COMPLAINTS PANEL (right column)
════════════════════════════════════════════ */
.ad-recent-panel {
  background: var(--white);
  border: 1px solid var(--border);
...
.ad-recent-item:last-child {
  border-bottom: none;
}

.ad-recent-item:hover {
  background: var(--maroon-pale);
}
...
@media (max-width: 640px) {
  .ad-hero { padding: 24px 16px 32px; }
          ...
          <div className="ad-hero-inner">
            <div>
              ...
              <div className="ad-hero-sub">
                {new Date().toLocaleDateString("en-IN", { weekday: "long", day: "numeric", month: "long", year: "numeric" })} &nbsp;·&nbsp; Manage cases, verify identities, and oversee all field operations.
              </div>
            </div>
            <div className="ad-hero-panel">
              ...
              {[
                { label: "Open Cases", val: "24" },
                { label: "Resolved Today", val: "6" },
