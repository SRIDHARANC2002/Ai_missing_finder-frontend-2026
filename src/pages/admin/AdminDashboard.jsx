  ...
  const AdminDashboard = () => {
    ...
    return (
      <>
        <style>{`
          /* ════════════════════════════════════════════
            ADMIN DASHBOARD — AI Missing Finder
          ...
          *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .ad-stat:hover .ad-stat-icon {
            background: var(--maroon); color: var(--gold-light); border-color: var(--maroon);
          }
          ...
          .ad-action-card:nth-child(1) { animation-delay: 0.25s; }
          .ad-action-card:nth-child(2) { animation-delay: 0.32s; }
          .ad-action-card:nth-child(3) { animation-delay: 0.39s; }
          ...
          .ad-action-card:hover {
            ...
            box-shadow: 0 6px 28px rgba(107,15,26,0.08);
          ...
          .ad-action-card:hover .ad-action-icon {
            background: var(--maroon); color: var(--gold-light); border-color: var(--maroon);
          }
          ...
          .ad-action-card:hover .ad-action-arrow {
            color: var(--maroon); transform: translateX(3px);
          }
          ...
          .ad-zone-card:nth-child(1) { animation-delay: 0.45s; }
          .ad-zone-card:nth-child(2) { animation-delay: 0.50s; }
          .ad-zone-card:nth-child(3) { animation-delay: 0.55s; }
          .ad-zone-card:nth-child(4) { animation-delay: 0.60s; }

          .ad-zone-card:hover {
            border-color: rgba(107,15,26,0.18);
            box-shadow: 0 4px 16px rgba(107,15,26,0.06);
          }
          ...
          .ad-zone-name {
            ...
            color: var(--maroon-deep); letter-spacing: 0.3px; margin-bottom: 10px;
          }
          ...
          .ad-zone-stat-val {
            ...
            color: var(--maroon-deep); line-height: 1; margin-bottom: 2px;
          }
          ...
          .ad-zone-alert-tag {
            ...
            border: 1px solid rgba(158,58,71,0.25);
            animation: ad-alert-blink 2s infinite;
          }
          ...
          .ad-recent-panel {
            ...
            animation: ad-fade-left 0.5s ease 0.3s both;
          }
          ...
          .ad-recent-dot {
            ...
            z-index: 2; border: 1.5px solid var(--white);
          }
          ...
          .ad-recent-id {
            font-family: var(--font-mono);
            font-size: 10.5px; color: var(--text-light); margin-bottom: 2px;
          }
          ...
          .ad-recent-time {
            font-family: var(--font-mono);
            font-size: 10.5px; color: var(--text-light); margin-bottom: 5px;
          }
          ...
          @media (max-width: 1100px) {
            .ad-hero { padding: 28px 24px 36px; }
            .ad-body { padding: 28px 24px 60px; }
          ...
          @media (max-width: 900px) {
            ...
            .ad-action-label { font-size: 15px; }
            .ad-action-sub { font-size: 12.5px; }
          }
          ...
          @media (max-width: 768px) {
            /* Hero */
            .ad-hero { padding: 24px 16px 30px; }
            .ad-hero-inner { gap: 20px; }
            .ad-hero-title { font-size: clamp(22px, 6vw, 32px); }
            .ad-hero-sub { font-size: 12.5px; }
            .ad-eyebrow { font-size: 9.5px; letter-spacing: 1.5px; }

            /* Body */
            .ad-body { padding: 20px 16px 60px; }

            /* Stats — 2 columns on mobile */
            .ad-stats { grid-template-columns: repeat(2, 1fr); }
            .ad-stat { padding: 18px 16px; }
            .ad-stat-value { font-size: 30px; letter-spacing: -1px; }
            .ad-stat-label { font-size: 10px; }
            .ad-stat-change { font-size: 10.5px; }
            .ad-stat-icon { width: 34px; height: 34px; margin-bottom: 10px; }

            /* Action cards — vertical stack, compress badge */
            .ad-action-card { gap: 14px; padding: 16px 16px; }
            .ad-action-icon { width: 42px; height: 42px; }
            .ad-action-label { font-size: 14.5px; }
            .ad-action-sub { font-size: 12px; }
            .ad-action-badge {
              font-size: 10px; padding: 3px 9px;
              /* keep badge visible but compact */
            }

            /* Zones — 2 col still works fine at 768, drop to 1 at 480 */
            .ad-zones { grid-template-columns: 1fr 1fr; gap: 8px; }
            .ad-zone-card { padding: 14px 14px; }
            .ad-zone-stat-val { font-size: 20px; }

            /* Recent panel */
            .ad-recent-item { padding: 12px 16px; gap: 10px; }
            .ad-recent-avatar { width: 38px; height: 38px; }
            .ad-recent-name { font-size: 13px; }
            .ad-recent-loc { font-size: 11px; }

            /* Section labels */
            .ad-section-label { font-size: 9.5px; margin-bottom: 12px; }
          }
          ...
          @media (max-width: 480px) {
            .ad-hero { padding: 20px 12px 26px; }
            .ad-body { padding: 16px 12px 56px; }

            /* Stats — single column on tiny screens */
            .ad-stats { grid-template-columns: 1fr 1fr; }
            .ad-stat { padding: 14px 12px; }
            .ad-stat-value { font-size: 26px; }
            .ad-stat-label { font-size: 9.5px; letter-spacing: 0.5px; }

            /* Hide arrow on smallest screens to save space */
            .ad-action-arrow { display: none; }

            /* Action card layout: icon + text only */
            .ad-action-card { padding: 14px 12px; gap: 12px; }
            .ad-action-icon { width: 38px; height: 38px; }
            .ad-action-label { font-size: 13.5px; }
            .ad-action-sub { display: none; }
            .ad-action-badge { font-size: 9.5px; padding: 3px 8px; }

            /* Zones — 1 column */
            .ad-zones { grid-template-columns: 1fr; }

            /* Recent panel */
            .ad-recent-head { padding: 13px 14px; }
            .ad-recent-title { font-size: 14px; }
            .ad-recent-item { padding: 11px 14px; }
            .ad-recent-avatar { width: 34px; height: 34px; }

            /* Hero eyebrow — hide rule lines for space */
            .ad-eyebrow-rule { display: none; }
          }
          ...
          @media (max-width: 360px) {
            ...
            .ad-hero-sub { font-size: 11.5px; }
            .ad-stat-value { font-size: 22px; }
            .ad-action-label { font-size: 12.5px; }
            .ad-zones { grid-template-columns: 1fr; }
          }
        `}</style>
        ...
        <div className="ad">
          ...
          <div className="ad-hero">
            <div className="ad-hero-inner">
              ...
              {/* Status panel — hidden on mobile via CSS */}
                ...
                <div className="ad-recent-panel">
                  ...
                  <div className="ad-recent-list">
                    {recentComplaints.map((r, i) => {
                      const statusClass = r.status === "Completed" ? "resolved"
                                        : r.status === "Approved"  ? "progress"
                                        : "open";
                      const dotColor    = r.status === "Completed" ? "#5a8a4a"
                                        : r.status === "Approved"  ? "#a0622a"
                                        : "#9e3a47";
                      return (
